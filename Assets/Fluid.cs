...
namespace StableFluids
{
    public class Fluid : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            TrackedGO = GameObject.FindGameObjectWithTag("trackedGO");
        ...
        void Update()
        {
            ...
            input = new Vector2(TrackedGO.transform.position.x, TrackedGO.transform.position.y);
            ...
            //   _compute.SetVector("ForceOrigin", inputold);
          ...
          //      _compute.SetVector("ForceVector", Random.insideUnitCircle * _force * 0.025f);
            ...
            //{
                ...
                //    _compute.SetVector("ForceVector", (inputold - _previousInput) * _force);
           // }
           // else
            ...
            var offs = Vector2.one * 1e+7f; //(Input.GetMouseButton(1) ? 0 : 1e+7f);
